...
@Service
public class RevReviewViewServiceBizImpl implements RevReviewViewServiceBiz {

    @Resource
    private RevReviewApiImpl reviewServiceBiz;
    ...
    public Page<ReviewItemVO> getReviewList(ReviewListQueryDTO dto) {
        RevStatus.REV_REVIEW_NOT_FOUND.assertThrowResEx(dto == null || RevSupport.isNullOrNonPositive(dto.getSpuId()));
